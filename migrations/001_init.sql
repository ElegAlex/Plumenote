...
CREATE INDEX idx_verification_log_document_id ON verification_log(document_id);
CREATE INDEX idx_verification_log_created_at ON verification_log(created_at DESC);
...
CREATE INDEX idx_view_log_document_id ON view_log(document_id);
CREATE INDEX idx_view_log_created_at ON view_log(created_at DESC);
